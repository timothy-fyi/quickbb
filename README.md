...
## Features
- Directly uploads images to ImgBB
- Copies the a shareable url to your clipboard
- Ability to be added to your computers "Send to" context menu for even easier uploading
